<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/CENTIL.jpeg); background-size: cover;">
              ...
              <li>
                  <div class="user-view">
                      <div class="background">
                          <img src="../img/CENTIL.jpeg">
                      </div>
                      <a href="#name"><span class="black-text name"><b><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></b></span></a>
                  </div>
              </li>
              <li><a href="index.php?p=dashboard"><i class="material-icons black-text">dashboard</i><b>Dashboard</b></a></li>
              <li><a href="index.php?p=registrasi"><i class="material-icons black-text">featured_play_list</i><b>Registrasi</b></a></li>
              <li><a href="index.php?p=pengaduan"><i class="material-icons black-text">report</i><b>Pengaduan</b></a></li>
              <li><a href="index.php?p=user"><i class="material-icons black-text">account_box</i><b>User</b></a></li>
              <li><a href="index.php?p=laporan"><i class="material-icons black-text">book</i><b>Laporan</b></a></li>
              <li>
                  <div class="divider"></div>
              </li>
              <li><a class="waves-effect" href="../index.php?p=logout"><i class="material-icons black-text">logout</i><b>Logout</b></a></li>
          </ul>
